<div class="container">
    ...
    <!-- <a href="<?= base_url('admin/laporan/create'); ?>" class="btn btn-primary mb-3 mt-3">Tambahkan</a> -->
            ...
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <!-- <a onclick="return confirm('Data laporan akan terhapus');" href="<?= base_url('admin/laporan/destroy/' . $data['id_laporan_donasi']); ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a> -->
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
